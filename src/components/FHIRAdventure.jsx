    ...
    >
      <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns: showingDialogue ? "1fr" : "2fr 1fr",
            gap: "20px",
          }}
        >
          {/* Main Content */}
          <div>
            {/* NPC Dialogue with Nurse Avatar */}
            ...
            {/* Computer Screen UI for Minigames */}
            {!showingDialogue && currentMinigame && (
              <div
                style={{
                  background: "#1e293b",
                  borderRadius: "20px",
              ...
              >
                ...
                >
                  ...
                  {/* Identifier Builder in Computer UI */}
                  {currentMinigame === "identifier-builder" && scenario && (
                    <div>
                      <div
                        style={{
                          background: "#fef3c7",
                      ...
                      >
                        ...
                        >
                          ...
                          🎯 Mission: Assign at least 2 unique identifiers to
                          each patient
                        </div>
                        <div style={{ fontSize: "14px", color: "#78350f" }}>
                          Different identifier types help distinguish patients
                          with similar names
                        </div>
                      </div>
                  ...
                  {/* Reference Linker */}
                  {currentMinigame === "reference-linker" && scenario && (
                    <div>
                      <div
                        style={{
                          background: "#fef3c7",
                      ...
                      <p style={{ marginBottom: "20px", color: "#64748b" }}>
                        Click a resource, then click another to create a
                        reference. Only valid connections work!
                      </p>
                      ...
                      >
                        {scenario.resources.map((resource) => {
                          ...
                          const isConnected = connections.some(
                            (c) =>
                              c.from === resource.id || c.to === resource.id
                          );
                  ...
                  {/* Code Translator */}
                  {currentMinigame === "code-translator" && scenario && (
                    <div>
                      <div
                        style={{
                          padding: "25px",
                      ...
                      <div style={{ marginBottom: "20px" }}>
                        {Object.entries(
                          scenario.items[currentCodeItem].codes
                        ).map(([system, code]) => (
                          <button
                            key={system}
                  ...
                  {currentMinigame === "subscription-builder" && scenario && (
                    <div>
                      <div
                        style={{
                          background: "#fef3c7",
                  ...
                  {/* Bundle Builder */}
                  {currentMinigame === "bundle-builder" && scenario && (
                    <div>
                      <div
                        style={{
                          background: "#fef3c7",
                      ...
                      >
                        <div style={{ fontWeight: "bold", color: "#92400e" }}>
                          🎯 Select ALL resources to include in the transfer
                          bundle
                        </div>
                      </div>
          ...
          {/* Sidebar - only show when not in dialogue mode */}
          {!showingDialogue && (
            <div
              style={{
                background: "white",
